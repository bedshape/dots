...
static const char *fonts[]                 = {"MesloLGS Nerd Font Propo:size=12"};
static const float rootcolor[]             = COLOR(0x000000ff);
/* This conforms to the xdg-protocol. Set the alpha to zero to restore the old behavior */
static const float fullscreen_bg[]         = {0.1f, 0.1f, 0.1f, 1.0f}; /* You can also use glsl colors */
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xa89984ff, 0x111111ff, 0x222222ff },
	[SchemeSel]  = { 0xebdbb2ff, 0x444444ff, 0xfb4934ff },
...
static const char *const autostart[] = {
	"/home/evie/scripts/bg.sh", NULL,
	"mako", NULL,
	"pipewire", NULL,
	"pipewire-pulse", NULL,
	"/home/evie/scripts/idle.sh", NULL,	
        NULL /* terminate */
};
...
static const char *lockcmd[] = { "/home/evie/scripts/lock.sh", NULL };
static const char *iscreencmd[] = { "iscreenshot.sh", NULL };
