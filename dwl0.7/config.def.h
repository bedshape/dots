...
static const char *fonts[]                 = {"CommitMono Nerd Font Propo:size=12"};
static const float rootcolor[]             = COLOR(0x000000ff);
/* This conforms to the xdg-protocol. Set the alpha to zero to restore the old behavior */
static const float fullscreen_bg[]         = {0.1f, 0.1f, 0.1f, 1.0f}; /* You can also use glsl colors */
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xebdbb2ff, 0x272727d9, 0x545454ff },
	[SchemeSel]  = { 0x272727ff, 0xb8ba25ff, 0xd3859aff },
...
static const char *const autostart[] = {
        "wbg", "/home/evie/wallpapers/mountwall.jpg", NULL,
        "mako", NULL,
        "pipewire", NULL,
        "pipewire-pulse", NULL,
	"swayidle", "-w", "timeout", "120", "/usr/local/bin/lock.sh", "before-sleep", "/usr/bin/waylock", NULL,
        NULL /* terminate */
};
...
static const MonitorRule monrules[] = {
	...
	*/
	/* defaults */
	{ NULL,       0.57f, 1,      1,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 },
};
...
static const char *lockcmd[] = { "/home/evie/.config/scripts/lock.sh", NULL };
static const char *iscreencmd[] = { "/home/evie/.config/scripts/iscreenshot.sh", NULL };
static const char *screencmd[] = { "/home/evie/.config/scripts/screenshot.sh", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_Print,      spawn,          {.v = iscreencmd} },
